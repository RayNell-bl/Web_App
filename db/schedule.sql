...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 08 2020 г., 22:08
...
(1, 'Смит', 'Джон', 'Тимофеевич', 'admin', '$2y$10$mFlJsQgNvDQ27XfADrMh8O9OQA47f2gLmqYdwGeg8SpsvdoRUX95S', 1, '2002-05-10', 1, 1);
...
--
ALTER TABLE `day`
  MODIFY `day_id` tinyint NOT NULL AUTO_INCREMENT;
